...
datasink2 = glueContext.write_dynamic_frame.from_options(frame = applymapping1, connection_type = "s3", connection_options = {"path": "s3://zoe-ssm-output", "compression": "gzip"}, format = "json", transformation_ctx = "datasink2")
job.commit()
